...
with tab_home:
    ...
    if st.session_state.show_add_form:
        with st.container(border=True):
            ...
            time_choice = st.radio(
                t("time_of_day_label"),
                [t("meal_breakfast"), t("meal_lunch"), t("meal_dinner")],
                key="home_manual_time", horizontal=True,
            )
                    ...
                    for name in matches:
                        ...
                        if already_added:
                            ...
                            time_choice = st.radio(
                                t("time_of_day_label"),
                                [t("meal_breakfast"), t("meal_lunch"), t("meal_dinner")],
                                key=f"scan_time_{name}", horizontal=True,
                            )
    ...
    if not my_medicines:
        ...
        col_listen, col_remove = st.columns(2)
        with col_listen:
